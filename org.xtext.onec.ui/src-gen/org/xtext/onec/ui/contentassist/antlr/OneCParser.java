...
* generated by Xtext
*/
package org.xtext.onec.ui.contentassist.antlr;
...
public class OneCParser extends AbstractContentAssistParser {
	...
	@Override
	protected org.xtext.onec.ui.contentassist.antlr.internal.InternalOneCParser createParser() {
		org.xtext.onec.ui.contentassist.antlr.internal.InternalOneCParser result = new org.xtext.onec.ui.contentassist.antlr.internal.InternalOneCParser(null);
	...
	protected String getRuleName(AbstractElement element) {
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				...
				{
					put(grammarAccess.getVarsAccess().getAlternatives_1_0(), "rule__Vars__Alternatives_1_0");
					put(grammarAccess.getXMethodAccess().getAlternatives(), "rule__XMethod__Alternatives");
					put(grammarAccess.getFuncAccess().getAlternatives_1_0(), "rule__Func__Alternatives_1_0");
					put(grammarAccess.getFuncAccess().getAlternatives_6(), "rule__Func__Alternatives_6");
					put(grammarAccess.getFuncAccess().getAlternatives_9_0(), "rule__Func__Alternatives_9_0");
					put(grammarAccess.getProcAccess().getAlternatives_1_0(), "rule__Proc__Alternatives_1_0");
					put(grammarAccess.getProcAccess().getAlternatives_6(), "rule__Proc__Alternatives_6");
					put(grammarAccess.getProcAccess().getAlternatives_9_0(), "rule__Proc__Alternatives_9_0");
					put(grammarAccess.getParametrAccess().getByValAlternatives_1_0(), "rule__Parametr__ByValAlternatives_1_0");
					put(grammarAccess.getOpEqualityAccess().getAlternatives(), "rule__OpEquality__Alternatives");
					put(grammarAccess.getVariableAccess().getPublicAlternatives_1_0(), "rule__Variable__PublicAlternatives_1_0");
					put(grammarAccess.getXOperatorAccess().getAlternatives(), "rule__XOperator__Alternatives");
					put(grammarAccess.getXOperatorAccess().getAlternatives_3_1(), "rule__XOperator__Alternatives_3_1");
					put(grammarAccess.getXOperatorAccess().getAlternatives_4_1(), "rule__XOperator__Alternatives_4_1");
					put(grammarAccess.getXOperatorAccess().getAlternatives_5_1(), "rule__XOperator__Alternatives_5_1");
					put(grammarAccess.getXOperatorAccess().getAlternatives_6_1(), "rule__XOperator__Alternatives_6_1");
					put(grammarAccess.getXOperatorAccess().getAlternatives_7_1(), "rule__XOperator__Alternatives_7_1");
					put(grammarAccess.getLetAccess().getAlternatives_1(), "rule__Let__Alternatives_1");
					put(grammarAccess.getLetAccess().getAlternatives_1_2_5(), "rule__Let__Alternatives_1_2_5");
					put(grammarAccess.getLetAccess().getAlternatives_1_3_1(), "rule__Let__Alternatives_1_3_1");
					put(grammarAccess.getFormalParamsAccess().getAlternatives_1(), "rule__FormalParams__Alternatives_1");
					put(grammarAccess.getForAccess().getAlternatives_0(), "rule__For__Alternatives_0");
					put(grammarAccess.getForAccess().getAlternatives_0_0_0(), "rule__For__Alternatives_0_0_0");
					put(grammarAccess.getForAccess().getAlternatives_0_0_1(), "rule__For__Alternatives_0_0_1");
					put(grammarAccess.getForAccess().getAlternatives_0_0_1_0_0(), "rule__For__Alternatives_0_0_1_0_0");
					put(grammarAccess.getForAccess().getAlternatives_0_0_1_0_2(), "rule__For__Alternatives_0_0_1_0_2");
					put(grammarAccess.getForAccess().getAlternatives_0_0_1_1_3(), "rule__For__Alternatives_0_0_1_1_3");
					put(grammarAccess.getForAccess().getAlternatives_0_1(), "rule__For__Alternatives_0_1");
					put(grammarAccess.getForAccess().getAlternatives_2(), "rule__For__Alternatives_2");
					put(grammarAccess.getForAccess().getAlternatives_4(), "rule__For__Alternatives_4");
					...
					put(grammarAccess.getOtherExprAccess().getAlternatives(), "rule__OtherExpr__Alternatives");
					put(grammarAccess.getXConstructorCallAccess().getAlternatives_1(), "rule__XConstructorCall__Alternatives_1");
					put(grammarAccess.getIfAccess().getAlternatives_0(), "rule__If__Alternatives_0");
					put(grammarAccess.getIfAccess().getAlternatives_2_0(), "rule__If__Alternatives_2_0");
					put(grammarAccess.getIfAccess().getAlternatives_4_0_0(), "rule__If__Alternatives_4_0_0");
					put(grammarAccess.getIfAccess().getAlternatives_4_2_0(), "rule__If__Alternatives_4_2_0");
					put(grammarAccess.getIfAccess().getAlternatives_5_0_0(), "rule__If__Alternatives_5_0_0");
					put(grammarAccess.getIfAccess().getAlternatives_6_0(), "rule__If__Alternatives_6_0");
					put(grammarAccess.getXBooleanLiteralAccess().getAlternatives_1(), "rule__XBooleanLiteral__Alternatives_1");
					put(grammarAccess.getTryAccess().getAlternatives_1(), "rule__Try__Alternatives_1");
					put(grammarAccess.getTryAccess().getAlternatives_3_0(), "rule__Try__Alternatives_3_0");
					put(grammarAccess.getTryAccess().getAlternatives_5(), "rule__Try__Alternatives_5");
					put(grammarAccess.getXNullLiteralAccess().getAlternatives(), "rule__XNullLiteral__Alternatives");
					...
					put(grammarAccess.getVarsAccess().getGroup_3(), "rule__Vars__Group_3__0");
					put(grammarAccess.getFuncAccess().getGroup(), "rule__Func__Group__0");
					put(grammarAccess.getFuncAccess().getGroup_1(), "rule__Func__Group_1__0");
					put(grammarAccess.getFuncAccess().getGroup_9(), "rule__Func__Group_9__0");
					...
					put(grammarAccess.getProcAccess().getGroup_1(), "rule__Proc__Group_1__0");
					put(grammarAccess.getProcAccess().getGroup_9(), "rule__Proc__Group_9__0");
					put(grammarAccess.getParametrAccess().getGroup(), "rule__Parametr__Group__0");
					put(grammarAccess.getParametrAccess().getGroup_3(), "rule__Parametr__Group_3__0");
					put(grammarAccess.getVariableAccess().getGroup(), "rule__Variable__Group__0");
					put(grammarAccess.getXOperatorAccess().getGroup_3(), "rule__XOperator__Group_3__0");
					put(grammarAccess.getXOperatorAccess().getGroup_4(), "rule__XOperator__Group_4__0");
					put(grammarAccess.getXOperatorAccess().getGroup_5(), "rule__XOperator__Group_5__0");
					put(grammarAccess.getXOperatorAccess().getGroup_6(), "rule__XOperator__Group_6__0");
					put(grammarAccess.getXOperatorAccess().getGroup_7(), "rule__XOperator__Group_7__0");
					put(grammarAccess.getLetAccess().getGroup(), "rule__Let__Group__0");
					put(grammarAccess.getLetAccess().getGroup_1_0(), "rule__Let__Group_1_0__0");
					put(grammarAccess.getLetAccess().getGroup_1_1(), "rule__Let__Group_1_1__0");
					put(grammarAccess.getLetAccess().getGroup_1_2(), "rule__Let__Group_1_2__0");
					put(grammarAccess.getLetAccess().getGroup_1_2_4(), "rule__Let__Group_1_2_4__0");
					put(grammarAccess.getLetAccess().getGroup_1_2_4_0(), "rule__Let__Group_1_2_4_0__0");
					put(grammarAccess.getLetAccess().getGroup_1_2_5_0(), "rule__Let__Group_1_2_5_0__0");
					put(grammarAccess.getLetAccess().getGroup_1_2_5_1(), "rule__Let__Group_1_2_5_1__0");
					put(grammarAccess.getLetAccess().getGroup_1_3(), "rule__Let__Group_1_3__0");
					put(grammarAccess.getLetAccess().getGroup_1_3_0(), "rule__Let__Group_1_3_0__0");
					put(grammarAccess.getLetAccess().getGroup_1_3_0_0(), "rule__Let__Group_1_3_0_0__0");
					put(grammarAccess.getLetAccess().getGroup_1_3_1_0(), "rule__Let__Group_1_3_1_0__0");
					put(grammarAccess.getLetAccess().getGroup_1_3_1_1(), "rule__Let__Group_1_3_1_1__0");
					put(grammarAccess.getFormalParamsAccess().getGroup(), "rule__FormalParams__Group__0");
					put(grammarAccess.getFormalParamsAccess().getGroup_1_0(), "rule__FormalParams__Group_1_0__0");
					put(grammarAccess.getFormalParamsAccess().getGroup_1_0_1(), "rule__FormalParams__Group_1_0_1__0");
					put(grammarAccess.getForAccess().getGroup(), "rule__For__Group__0");
					put(grammarAccess.getForAccess().getGroup_0_0(), "rule__For__Group_0_0__0");
					put(grammarAccess.getForAccess().getGroup_0_0_1_0(), "rule__For__Group_0_0_1_0__0");
					put(grammarAccess.getForAccess().getGroup_0_0_1_1(), "rule__For__Group_0_0_1_1__0");
					put(grammarAccess.getDateLiteralAccess().getGroup(), "rule__DateLiteral__Group__0");
					put(grammarAccess.getOtherExprAccess().getGroup_0(), "rule__OtherExpr__Group_0__0");
					...
					put(grammarAccess.getIfAccess().getGroup_4_2(), "rule__If__Group_4_2__0");
					...
					put(grammarAccess.getTryAccess().getGroup_3(), "rule__Try__Group_3__0");
					put(grammarAccess.getXNullLiteralAccess().getGroup_0(), "rule__XNullLiteral__Group_0__0");
					put(grammarAccess.getXNullLiteralAccess().getGroup_1(), "rule__XNullLiteral__Group_1__0");
					put(grammarAccess.getXNullLiteralAccess().getGroup_2(), "rule__XNullLiteral__Group_2__0");
					...
					put(grammarAccess.getModuleAccess().getVariablesAssignment_2(), "rule__Module__VariablesAssignment_2");
					put(grammarAccess.getModuleAccess().getMethodsAssignment_3(), "rule__Module__MethodsAssignment_3");
					put(grammarAccess.getModuleAccess().getBlockAssignment_4(), "rule__Module__BlockAssignment_4");
					put(grammarAccess.getVarsAccess().getContextAssignment_0(), "rule__Vars__ContextAssignment_0");
					put(grammarAccess.getVarsAccess().getVariablesAssignment_2(), "rule__Vars__VariablesAssignment_2");
					put(grammarAccess.getVarsAccess().getVariablesAssignment_3_1(), "rule__Vars__VariablesAssignment_3_1");
					put(grammarAccess.getFuncAccess().getContextAssignment_0(), "rule__Func__ContextAssignment_0");
					put(grammarAccess.getFuncAccess().getRetValAssignment_1_0_0(), "rule__Func__RetValAssignment_1_0_0");
					put(grammarAccess.getFuncAccess().getRetValAssignment_1_0_1(), "rule__Func__RetValAssignment_1_0_1");
					put(grammarAccess.getFuncAccess().getNameAssignment_2(), "rule__Func__NameAssignment_2");
					put(grammarAccess.getFuncAccess().getParamsAssignment_4(), "rule__Func__ParamsAssignment_4");
					put(grammarAccess.getFuncAccess().getPublicAssignment_6_0(), "rule__Func__PublicAssignment_6_0");
					put(grammarAccess.getFuncAccess().getPublicAssignment_6_1(), "rule__Func__PublicAssignment_6_1");
					put(grammarAccess.getFuncAccess().getVariablesAssignment_7(), "rule__Func__VariablesAssignment_7");
					put(grammarAccess.getFuncAccess().getBlockAssignment_8(), "rule__Func__BlockAssignment_8");
					...
					put(grammarAccess.getBlockAccess().getOperatorsAssignment_0(), "rule__Block__OperatorsAssignment_0");
					put(grammarAccess.getBlockAccess().getOperatorsAssignment_1_1(), "rule__Block__OperatorsAssignment_1_1");
					put(grammarAccess.getProcAccess().getContextAssignment_0(), "rule__Proc__ContextAssignment_0");
					put(grammarAccess.getProcAccess().getNameAssignment_2(), "rule__Proc__NameAssignment_2");
					put(grammarAccess.getProcAccess().getParamsAssignment_4(), "rule__Proc__ParamsAssignment_4");
					put(grammarAccess.getProcAccess().getPublicAssignment_6_0(), "rule__Proc__PublicAssignment_6_0");
					put(grammarAccess.getProcAccess().getPublicAssignment_6_1(), "rule__Proc__PublicAssignment_6_1");
					put(grammarAccess.getProcAccess().getVariablesAssignment_7(), "rule__Proc__VariablesAssignment_7");
					put(grammarAccess.getProcAccess().getBlockAssignment_8(), "rule__Proc__BlockAssignment_8");
					put(grammarAccess.getParametrAccess().getByValAssignment_1(), "rule__Parametr__ByValAssignment_1");
					put(grammarAccess.getParametrAccess().getNameAssignment_2(), "rule__Parametr__NameAssignment_2");
					put(grammarAccess.getParametrAccess().getValueAssignment_3_1(), "rule__Parametr__ValueAssignment_3_1");
					put(grammarAccess.getVariableAccess().getNameAssignment_0(), "rule__Variable__NameAssignment_0");
					put(grammarAccess.getVariableAccess().getPublicAssignment_1(), "rule__Variable__PublicAssignment_1");
					put(grammarAccess.getXOperatorAccess().getValueAssignment_3_2(), "rule__XOperator__ValueAssignment_3_2");
					put(grammarAccess.getXOperatorAccess().getValueAssignment_4_2(), "rule__XOperator__ValueAssignment_4_2");
					put(grammarAccess.getLetAccess().getNameAssignment_0(), "rule__Let__NameAssignment_0");
					put(grammarAccess.getLetAccess().getValueAssignment_1_0_1(), "rule__Let__ValueAssignment_1_0_1");
					put(grammarAccess.getLetAccess().getRightAssignment_1_1_2(), "rule__Let__RightAssignment_1_1_2");
					put(grammarAccess.getLetAccess().getParamsAssignment_1_2_2(), "rule__Let__ParamsAssignment_1_2_2");
					put(grammarAccess.getLetAccess().getIndexAssignment_1_2_4_0_1(), "rule__Let__IndexAssignment_1_2_4_0_1");
					put(grammarAccess.getLetAccess().getValueAssignment_1_2_5_0_1(), "rule__Let__ValueAssignment_1_2_5_0_1");
					put(grammarAccess.getLetAccess().getRightAssignment_1_2_5_1_1(), "rule__Let__RightAssignment_1_2_5_1_1");
					put(grammarAccess.getLetAccess().getIndexAssignment_1_3_0_0_1(), "rule__Let__IndexAssignment_1_3_0_0_1");
					put(grammarAccess.getLetAccess().getValueAssignment_1_3_1_0_1(), "rule__Let__ValueAssignment_1_3_1_0_1");
					put(grammarAccess.getLetAccess().getRightAssignment_1_3_1_1_1(), "rule__Let__RightAssignment_1_3_1_1_1");
					put(grammarAccess.getFormalParamsAccess().getParamsAssignment_1_0_0(), "rule__FormalParams__ParamsAssignment_1_0_0");
					put(grammarAccess.getFormalParamsAccess().getParamsAssignment_1_0_1_1(), "rule__FormalParams__ParamsAssignment_1_0_1_1");
					put(grammarAccess.getForAccess().getNameAssignment_0_0_1_0_1(), "rule__For__NameAssignment_0_0_1_0_1");
					put(grammarAccess.getForAccess().getNameAssignment_0_0_1_1_0(), "rule__For__NameAssignment_0_0_1_1_0");
					put(grammarAccess.getForAccess().getValueAssignment_0_0_1_1_2(), "rule__For__ValueAssignment_0_0_1_1_2");
					put(grammarAccess.getForAccess().getBoundaryAssignment_1(), "rule__For__BoundaryAssignment_1");
					put(grammarAccess.getForAccess().getBlockAssignment_3(), "rule__For__BlockAssignment_3");
					put(grammarAccess.getDateLiteralAccess().getValueAssignment_1(), "rule__DateLiteral__ValueAssignment_1");
					put(grammarAccess.getOtherExprAccess().getIfAssignment_0_2(), "rule__OtherExpr__IfAssignment_0_2");
					put(grammarAccess.getOtherExprAccess().getThenAssignment_0_4(), "rule__OtherExpr__ThenAssignment_0_4");
					put(grammarAccess.getOtherExprAccess().getElseAssignment_0_6(), "rule__OtherExpr__ElseAssignment_0_6");
					put(grammarAccess.getXConstructorCallAccess().getConstructorAssignment_2(), "rule__XConstructorCall__ConstructorAssignment_2");
					put(grammarAccess.getXConstructorCallAccess().getExplicitConstructorCallAssignment_3_0(), "rule__XConstructorCall__ExplicitConstructorCallAssignment_3_0");
					put(grammarAccess.getXConstructorCallAccess().getArgumentsAssignment_3_1_0(), "rule__XConstructorCall__ArgumentsAssignment_3_1_0");
					put(grammarAccess.getXConstructorCallAccess().getArgumentsAssignment_3_1_1_1(), "rule__XConstructorCall__ArgumentsAssignment_3_1_1_1");
					put(grammarAccess.getXConstructorCallAccess().getArgumentsAssignment_4(), "rule__XConstructorCall__ArgumentsAssignment_4");
					put(grammarAccess.getIfAccess().getConditionAssignment_1(), "rule__If__ConditionAssignment_1");
					put(grammarAccess.getIfAccess().getBlockAssignment_3(), "rule__If__BlockAssignment_3");
					put(grammarAccess.getIfAccess().getConditionAssignment_4_1(), "rule__If__ConditionAssignment_4_1");
					put(grammarAccess.getIfAccess().getBlockAssignment_4_3(), "rule__If__BlockAssignment_4_3");
					put(grammarAccess.getIfAccess().getAlterblockAssignment_5_1(), "rule__If__AlterblockAssignment_5_1");
					put(grammarAccess.getXBooleanLiteralAccess().getIsTrueAssignment_1_1(), "rule__XBooleanLiteral__IsTrueAssignment_1_1");
					put(grammarAccess.getXBooleanLiteralAccess().getIsTrueAssignment_1_3(), "rule__XBooleanLiteral__IsTrueAssignment_1_3");
					put(grammarAccess.getTryAccess().getBlockAssignment_2(), "rule__Try__BlockAssignment_2");
					put(grammarAccess.getTryAccess().getAlterblockAssignment_4(), "rule__Try__AlterblockAssignment_4");
	...
	protected Collection<FollowElement> getFollowElements(AbstractInternalContentAssistParser parser) {
		try {
			org.xtext.onec.ui.contentassist.antlr.internal.InternalOneCParser typedParser = (org.xtext.onec.ui.contentassist.antlr.internal.InternalOneCParser) parser;
	...
	protected String[] getInitialHiddenTokens() {
		return new String[] { "RULE_WS", "RULE_SL_COMMENT", "RULE_PREPROCESSOR" };
	}
