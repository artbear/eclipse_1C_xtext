 ...
 * <ul>
 *   <li>{@link org.xtext.onec.oneC.XBooleanLiteral#isIsTrue <em>Is True</em>}</li>
 * </ul>
 * </p>
 *
 * @see org.xtext.onec.oneC.OneCPackage#getXBooleanLiteral()
 * @model
 * @generated
 */
public interface XBooleanLiteral extends XExpression
{
   ...
   * @see org.xtext.onec.oneC.OneCPackage#getXBooleanLiteral_IsTrue()
   * @model
   * @generated
   */
  boolean isIsTrue();
  ...
  /**
   * Sets the value of the '{@link org.xtext.onec.oneC.XBooleanLiteral#isIsTrue <em>Is True</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
